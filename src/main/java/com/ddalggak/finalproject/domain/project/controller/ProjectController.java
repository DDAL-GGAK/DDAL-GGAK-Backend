...
public class ProjectController {
	...
	@Operation(summary = "프로젝트 초대 코드 생성", description = "api for create project invite code")
	@PostMapping("/project/{projectId}/invite")
	public ResponseEntity<?> createProjectInviteCode(
		@AuthenticationPrincipal UserDetailsImpl userDetails,
		@PathVariable Long projectId) {
		return projectService.createProjectInviteCode(userDetails.getUser(), projectId);
	}
