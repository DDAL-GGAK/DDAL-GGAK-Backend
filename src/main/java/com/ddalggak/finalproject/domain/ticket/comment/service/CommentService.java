...
public class CommentService {
	...
	// }
	@Transactional
	public ResponseEntity<SuccessResponseDto> deleteComment(UserDetailsImpl userDetails, Long ticketId,
		Long commentId) {
		Ticket ticket = getTicket(ticketId);
	...
	private Comment getComment(Long commentId) {
		return commentRepository.findById(commentId).orElseThrow(() -> new CustomException(NOT_FOUND_COMMENT));
	}
